...
const authRoutes = require("./routes/auth");   // Add at the top
...
const corsOptions = {
  origin: function (origin, callback) {
    ...
    if (!process.env.FRONTEND_URL && origin === 'http://localhost:3000') {
      return callback(null, true);
    }
...
app.use("/api/auth", authRoutes);  // Add after app setup (after app.use(cors()) and app.use(bodyParser.json()))
...
// to add dumy data of holdings and positions once ..
...
// to add dumy dataof positions once..
