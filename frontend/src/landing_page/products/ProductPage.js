...
function ProductPage() {
    return (  
     ...
     <RightSection
        ...
        productName="Console"
        productDescription="The central dashboard for your TradeFlux account.
     ...
     <LeftSection 
        ...
        appStore="#"
     />
     <p style={{textAlign:"center"}}>Want to know more about our technology stack? Check out the TradeFlux.tech blog.</p>
